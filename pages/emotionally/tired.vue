...
<template>
    ...
    <div style="display:flex; justify-content:center; align-items:center; min-height: 812px; height: 100%;">
        <div style="height:640px; width: 642px; background:#424F3DB2; display: flex; justify-content: center; align-items: center; flex-direction: column; text-align: center; padding: 0 10px 0 10px;">
            ...
            <p style="color:#fff; text-align: center; font-size: 20px; padding-top: 19px;">Cut out caffeine</p>
            <p style="color:#fff; text-align: center; font-size: 20px; padding-top: 19px;">Rule out health problems</p>
            <p style="color:#fff; text-align: center; font-size: 20px; padding-top: 19px;">Drink more water for better energy</p>
            <p style="color:#fff; text-align: center; font-size: 20px; padding-top: 19px;">Eat several small meals<br>instead of large, heavy ones</p>
            <p style="color:#fff; text-align: center; font-size: 20px; padding-top: 19px;">Make an effort to move more </p>
